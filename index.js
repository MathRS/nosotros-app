...
// Evita CORS bloqueando o acesso do navegador
const cors = require('cors');
app.use(cors());


const imagens = {
  imagem1: "https://drive.google.com/uc?export=view&id=1BcBwbkoqdsV5yVU856xLFHrH3rNAh589",
  imagem2: "https://drive.google.com/uc?export=view&id=SEU_ID_AQUI"
};
...
// Rota pública para acessar imagens sem mostrar os links reais no app
app.get('/imagem/:id', (req, res) => {
  const id = req.params.id;
  const link = imagens[id];
